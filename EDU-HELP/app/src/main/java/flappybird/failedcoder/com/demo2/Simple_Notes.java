...
public class Simple_Notes extends AppCompatActivity {
                            ...
                            if (dataSnapshot.hasChild("title") && dataSnapshot.hasChild("timestamp")) {
                                ...
                                viewHolder.noteCard.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        Intent intent = new Intent(Simple_Notes.this, NewNoteActivity.class);
...
//        } else {
//            Intent startIntent = new Intent(Simple_Notes.this, Home.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.main_new_note_btn:
                Intent newIntent = new Intent(Simple_Notes.this, NewNoteActivity.class);
